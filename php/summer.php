                ...
                foreach ($courses as $course) {
                    ...
                    if ($course['is_lab']) {
                        while ($group_count < $num_groups && $slot_index < count($time_slots_lab)) {
                            $time_slot_index = array_rand($time_slots_lab); // للمعاملات التجريبية
                            $time_slot = $time_slots_lab[$time_slot_index];
                        ...
                        while ($group_count < $num_groups && $slot_index < count($time_slots_theory)) {
                            $time_slot_index = array_rand($time_slots_theory); // للمعاملات التجريبية
                            $time_slot = $time_slots_theory[$time_slot_index];
                            foreach ($roomsLabs as $room) {
